...
export interface TempFactAttributes {
  id: number;
...
export class TempFact extends Model<TempFactAttributes, TempFactCreationAttributes> implements TempFactAttributes {
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof TempFact {
    TempFact.init({
    id: {
      autoIncrement: true,
