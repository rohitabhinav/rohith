...
export interface AggCostanalysisImshipmentsAttributes {
...
export class AggCostanalysisImshipments extends Model<AggCostanalysisImshipmentsAttributes, AggCostanalysisImshipmentsCreationAttributes> implements AggCostanalysisImshipmentsAttributes {
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof AggCostanalysisImshipments {
    AggCostanalysisImshipments.init({
    pickupAddress2: {
    ...
    sequelize,
    tableName: 'agg_costanalysis_imshipments',
    timestamps: true
  });
  return AggCostanalysisImshipments;
  }
}
