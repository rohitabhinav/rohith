...
export class ImAnalyticsPersistence_Gsk implements BaseService {
    
    
    private kafkav: Kafka = new Kafka({ 
        clientId: process.env.KAFKA_CLIENT_ID_ANASHIP_GSK,
   ...
   //private erroredMessagesRepository:ErroredMessagesRepository;
    ...
    async consumeAnalyticRequest() {
        ...
        this.logger.log(`Topic name is ${process.env.CONSUME_TOPIC!}`)
